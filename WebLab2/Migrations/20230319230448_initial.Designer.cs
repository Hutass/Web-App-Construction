...
namespace WebLab2.Migrations
{
    ...
    [Migration("20230319230448_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebLab2.Models.Position", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebLab2.Models.Question", b =>
                {
                    b.HasOne("WebLab2.Models.Position", "Position")
                        .WithMany("Questions")
                        .HasForeignKey("PositionId")
                        .HasConstraintName("FK_Question_Position");
            ...
            modelBuilder.Entity("WebLab2.Models.TestResult", b =>
                {
                    ...
                    b.HasOne("WebLab2.Models.Position", "Position")
                        .WithMany("TestResults")
                        .HasForeignKey("PositionId")
                        .HasConstraintName("FK_TestResult_Position");
